                ...
                if(!$fileTmpLoc){
        		  ...
        		  if(!$fileSize > 1048576){
                    ...
                    $check = "0";						
					 ...
					 array("fl_filename"=>$fileName,"fl_code"=>$_SESSION['code_request'],'fl_type'=>'application/zip','fl_min_path'=>$min_path,'fl_full_path'=>$full_path,'fl_user_id'=>$_SESSION['user_id'],'fl_state'=>'1','fl_timestamp'=>time(),'fl_size'=>$fileSize));
