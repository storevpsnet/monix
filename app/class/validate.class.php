        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_required' :
                    $resp[] = "<p class=\"er_fild\"> فیلد <span class=\"$field_class\">$field</span> ضروری میباشد </p>";
                    break;
                case 'validate_valid_email':
                    $resp[] = "The <span class=\"$field_class\">$field</span> field is required to be a valid email address";
                    break;
                case 'validate_max_len':
                    $resp[] = "<p  class=\"er_fild\"> فیلد <span class=\"$field_class\">$field</span>  باید حداکثر $param کاراکتر باشد </p>";
                    break;
                case 'validate_min_len':
                    $resp[] = "<p  class=\"er_fild\"> فیلد <span class=\"$field_class\">$field</span>  حداقل باید $param کاراکتر باشد </p>";
                    break;  
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                case 'mismatch' :
                    ...
                    break;
                case 'validate_required':
                    $resp[$field] = "فیلد $field ضروری میباشد";
                    break;
                case 'validate_valid_email':
